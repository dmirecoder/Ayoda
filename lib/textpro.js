...
async function textpro2(url, text, text2) {
  ...
  if (typeof text2 === "string") text2 = [text2];
  for (let tex of text2) form.append("text[]", tex);
...
module.exports = { textpro, textpro2, ephoto }